...
import com.example.malllearning.dao.BrandDao;
...
public class PmsBrandController {
    ...
    @ResponseBody
    public CommonResult<PmsBrand> brandId(@PathVariable("id") Long id) {
        return CommonResult.success(brandDao.getPmsBrand(id));
    }
}
